...
Exit Sub
err_Unzip:
    frmMain.lEstado.Caption = "Error al Unzipear, pruebe que el archivo sea un original .ZIP y no .RAR"
...
MsgBox "No puedes ejecutar el revival mas de 1 vez"
End
Exit Sub
End If
Load frmMain
Call frmMain.Analizar
End Sub
