...
Call cargarImagenRes(frmBancoObj, 102)
Call cargarImagenRes(frmBancoObj.Image1(0), 103)
Call cargarImagenRes(frmBancoObj.Image1(1), 104)
'Me.Picture = LoadPicture(App.Path & "\Graficos\Boveda.jpg")
'Image1(0).Picture = LoadPicture(App.Path & "\Graficos\BotónComprar.jpg")
'Image1(1).Picture = LoadPicture(App.Path & "\Graficos\BotónDepositar.jpg")
   ...
   '             Image1(0).Picture = LoadPicture(App.Path & "\Graficos\BotónComprarApretado.jpg")
    ...
    'Case 1
        'If Image1(1).Tag = 1 Then
                'Image1(1).Picture = LoadPicture(App.Path & "\Graficos\BotónDepositarApretado.jpg")
                'Image1(1).Tag = 0
                'Image1(0).Picture = LoadPicture(App.Path & "\Graficos\BotónComprar.jpg")
                'Image1(0).Tag = 1
        'End If
