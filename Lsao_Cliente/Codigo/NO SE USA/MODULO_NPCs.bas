...
Npc2Pos.Y = 56
   ...
   MiNPC = Npclist(NpcIndex)
    ...
    AlmacenaDominador = Guilds(UserList(UserIndex).GuildIndex).GuildName
        Call SendData(ToAll, 0, 0, "||Castillo> El castillo de Ullathorpe fue conquistado por el clan " & AlmacenaDominador & "." & FONTTYPE_GUILD)
    ...
    AlmacenaDominadornix = Guilds(UserList(UserIndex).GuildIndex).GuildName
        Call SendData(ToAll, 0, 0, "||Castillo> El castillo de Nix fue conquistado por el clan " & AlmacenaDominadornix & "." & FONTTYPE_GUILD)
