...
Call SendData(SendTarget.toall, 0, 0, "||RevivalAo> Iniciando Guardado del Mundo." & FONTTYPE_SERVER)
...
Call SendData(SendTarget.toall, 0, 0, "||RevivalAo> Guardado del Mundo Ha concluído." & FONTTYPE_SERVER)
