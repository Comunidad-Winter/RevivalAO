...
On Error GoTo errorh
    ...
    Do Until (Npclist(NpcIndex).Invent.Object(Slot).ObjIndex = obji _
      And Npclist(NpcIndex).Invent.Object(Slot).Amount + Cantidad <= MAX_INVENTORY_OBJS)
        ...
        Slot = Slot + 1
            '[MaTeO 5]
        If Slot > MAX_INVENTORY_SLOTS_NPC Then Exit Do
        '[/MaTeO 5]
   ...
   '[MaTeO 5]
    If Slot > MAX_INVENTORY_SLOTS_NPC Then
    '[/MaTeO 5]
        ...
        Loop
                '[MaTeO 5]
        If Slot <= MAX_INVENTORY_SLOTS_NPC Then Npclist(NpcIndex).Invent.NroItems = Npclist(NpcIndex).Invent.NroItems + 1
        '[/MaTeO 5]
       
    End If
    
       '[MaTeO 5]
    If Slot <= MAX_INVENTORY_SLOTS_NPC Then 'Slot valido
    '[/MaTeO 5]
        'Mete el obj en el slot
...
On Error GoTo errhandler
    ...
    Call EnviarOro(UserIndex)
   '[MaTeO 5]
    If i > MAX_INVENTORY_SLOTS_NPC Then
    '[/MaTeO 5]
...
Sub EnviarNpcInv(ByVal UserIndex As Integer, ByVal NpcIndex As Integer)
    ...
    If Desc = 0 Then Desc = 1 'evitamos dividir por 0!
      ...
      '[MaTeO 5]
    For i = 1 To MAX_INVENTORY_SLOTS_NPC
    '[/MaTeO 5]
