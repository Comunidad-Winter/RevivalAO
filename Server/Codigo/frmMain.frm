      ...
      If UserList(iUserIndex).ConnIDValida And UserList(iUserIndex).flags.UserLogged Then
        ...
        If UserList(iUserIndex).pos.Map = 70 Then
            ...
            If UserList(iUserIndex).Counters.Laberinto = Fix(20000 / GameTimer.Interval) Then
                Call WarpUserCharX(iUserIndex, 70, 13, 12)
                UserList(iUserIndex).Counters.Laberinto = 0
            End If
        End If
        
             If UserList(iUserIndex).pos.Map = 117 Then
            UserList(iUserIndex).Counters.maparql = UserList(iUserIndex).Counters.maparql + 1
            If UserList(iUserIndex).Counters.maparql = Fix(1200000 / GameTimer.Interval) Then
                Call WarpUserCharX(iUserIndex, 1, 50, 50)
                Call SendData(SendTarget.toIndex, iUserIndex, 0, "||Se te acabo el tiempo de entrenamiento!" & FONTTYPE_INFO)
                UserList(iUserIndex).Counters.maparql = 0
            End If
        End If
        '[/MaTeO 10]
...
Inet2.URL = "http://www.revivalao.com.ar/estado.php?index=OFFLINE"
Inet2.OpenURL
    Dim f
    For Each f In Forms
        Unload f
...
ThePos.x = 72
ThePos.Y = 74
If Time > "17:00" And Time < "17:04" And MazIndex = 0 Then
...
ElseIf Hour(Time) = 18 And MazIndex <> 0 Then
...
If asdff = 5 Then
frmMain.Inet1.URL = "http://www.revivalao.com.ar/ranking.php?index=" & Ranking.MaxUsuariosMatados.UserName & " (" & Ranking.MaxUsuariosMatados.value & ")"
frmMain.Inet1.OpenURL
End If

If asdff = 6 Then
frmMain.Inet1.URL = "http://www.revivalao.com.ar/ranking2.php?index=" & Ranking.MaxTrofeos.UserName & " (" & Ranking.MaxTrofeos.value & ")"
frmMain.Inet1.OpenURL
End If

If asdff = 7 Then

frmMain.Inet1.URL = "http://www.revivalao.com.ar/ranking3.php?index=" & Ranking.MaxOro.UserName & " (" & Ranking.MaxOro.value & ")"
frmMain.Inet1.OpenURL
End If

If asdff = 8 Then
Inet1.URL = "http://www.revivalao.com.ar/castillonix.php?index=" & AlmacenaDominadornix
Inet1.OpenURL
End If


If asdff = 9 Then
Inet1.URL = "http://www.revivalao.com.ar/castilloulla.php?index=" & AlmacenaDominador
Inet1.OpenURL
End If

If asdff = 10 Then

Inet1.URL = "http://www.revivalao.com.ar/fortaleza.php?index=" & Fortaleza
Inet1.OpenURL

End If
If asdff = 11 Then
Inet1.URL = "http://www.revivalao.com.ar/castillolemuria.php?index=" & Lemuria
Inet1.OpenURL
End If
If asdff = 12 Then
Inet1.URL = "http://www.revivalao.com.ar/castillotale.php?index=" & Tale
Inet1.OpenURL
asdff = 0
End If
End Sub
...
On Error Resume Next
Inet2.URL = "http://www.revivalao.com.ar/user.php?index=" & NumUsers
Inet2.OpenURL
End Sub
...
For i = 1 To LastUser
    If UserList(i).flags.UserLogged Then
            ...
            If MapData(UserList(i).pos.Map, UserList(i).pos.x, UserList(i).pos.Y).trigger = eTrigger.ANTIPIQUETE Then
                    ...
                    If UserList(i).Counters.PiqueteC > 4 Then 'aca era 23
