...
Call SendData(SendTarget.ToAll, 0, 0, "||ZeusAO> Iniciando Guardado del Mundo." & FONTTYPE_SERVER)
...
Call SendData(SendTarget.ToAll, 0, 0, "||ZeusAO> Guardado del Mundo Ha concluído." & FONTTYPE_SERVER)
