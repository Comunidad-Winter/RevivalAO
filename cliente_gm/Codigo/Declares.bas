...
Option Explicit
Public Autoaim As Boolean
Public puedehablar As Boolean
Public textogm As String
Public TemporalFile As String
'[MaTeO ASEDIO]
Public TiempoAsedio As Long
'[/MaTeO ASEDIO]
Public SubElemento As ListItem
'[MaTeO 11]
Public IndexSet As Long
Public VelocidadLimiter As Byte
...
Public Const Mensaje38 As String = "AntiCheat> Tu Cliente es Valido, Gracias por jugar RevivalAo!!"
