...
errorH:
    Call MsgBox("Error cargando los servidores, actualicelos de la web", vbCritical + vbOKOnly, "LSAO")
    End
End Sub
...
' Lee tu serial unica de disco duro, utiliza referencia windows scripting runtime
'Dim fso As New Scripting.FileSystemObject
'Dim dr As Scripting.Drive
'Set dr = fso.GetDrive("c:")
' numero serie disco duro tuki "1883333921"
'If dr.SerialNumber = 1214851977 Then
'Else
'MsgBox "Este programa no fue hecho para ti, lo siento =)", vbCritical
'End
'End If
...
'Call MsgBox("Ya está siendo ejecutado LSAo!.", vbApplicationModal + vbInformation + vbOKOnly, "Error al ejecutar")
'End
'End If
...
#End If
    ...
    EstaBloqueado = Val(GetVar(App.Path & "\init\sinfo.dat", "s10", "PJ"))
    ...
    If App.PrevInstance Then
        Call MsgBox("LSAO ya esta corriendo! No es posible correr otra instancia del juego. Haga click en Aceptar para salir.", vbApplicationModal + vbInformation + vbOKOnly, "Error al ejecutar")
        End
    End If
...
#End If
    ...
    AddtoRichTextBox frmCargando.Status, "                    ¡Bienvenido a LSAO!", , , , 1
...
Public Sub ShowSendCMSGTxt()
    ...
    End If
End Sub
Public Sub ShowGmtxt()
    If Not frmCantidad.Visible Then
        frmMain.Gmtxt.Visible = True
        frmMain.Gmtxt.SetFocus
    End If
End Sub
