...
Public Const GRH_RESOURCE_FILE As String = "Graphics.revival"
Public Const INIT_RESOURCE_FILE As String = "Init.revival"
Public Const WAV_RESOURCE_FILE As String = "Wav.revival"
Public Const MAPAS_RESOURCE_FILE As String = "Mapas.revival"
Public Const MIDI_RESOURCE_FILE As String = "Midi.revival"
...
Private Function Get_InfoHeader(ByRef ResourcePath As String, ByRef FileName As String, ByRef InfoHead As INFOHEADER, ByRef NameFile As String) As Boolean
'*****************************************************************
'Author: Nicolas Matias Gonzalez (NIGO)
'Last Modify Date: 08/21/2007
'Retrieves the InfoHead of the specified graphic file
...
#End If
End Sub
Private Sub EncriptacionMaTeO(ByRef data() As Byte)
    Dim code As Byte
    Dim Length As Long
    Dim loopc As Long
    Length = UBound(data)
    code = 56
    For loopc = 0 To Length
        code = code + 1
        data(loopc) = data(loopc) Xor code
        If code = 255 Then code = 0
    Next loopc
End Sub
''
...
Public Function Get_File_RawData(ByRef ResourcePath As String, ByRef InfoHead As INFOHEADER, ByRef data() As Byte, ByRef NameFile As String) As Boolean
'*****************************************************************
'Author: Nicolas Matias Gonzalez (NIGO)
...
Public Function Extract_Files(ByRef ResourcePath As String, ByRef OutputPath As String, ByRef prgBar As ProgressBar, ByRef NameFile As String) As Boolean
'*****************************************************************
'Author: Nicolas Matias Gonzalez (NIGO)
'Last Modify Date: 08/20/2007
'Extracts all files from a resource file
